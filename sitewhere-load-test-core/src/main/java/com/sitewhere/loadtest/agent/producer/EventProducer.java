...
public class EventProducer extends LifecycleComponent implements IEventProducer {
    ...
    /**
     * Calculated cutoff value between 0 and 1 where a location should be
     * generated
     */
    private double alertCutoff;

    /**
     * Calculated cutoff value between 0 and 1 where measurements should be
     * generated
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.sitewhere.loadtest.spi.agent.IEventProducer#produceEvent(com.
	...
	DecodedDeviceRequest<IDeviceAlertCreateRequest> request = new DecodedDeviceRequest<IDeviceAlertCreateRequest>();
	...
	DecodedDeviceRequest<IDeviceLocationCreateRequest> request = new DecodedDeviceRequest<IDeviceLocationCreateRequest>();
     ...
     * 
     * @see
     * com.sitewhere.loadtest.spi.agent.IEventProducer#getThrottleDelayInMs()
     */
