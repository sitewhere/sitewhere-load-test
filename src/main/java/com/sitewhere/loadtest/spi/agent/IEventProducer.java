...
public interface IEventProducer extends ILifecycleComponent {
	...
	/**
	 * Get amount of time in milliseconds to wait between producing messages. Depending on
	 * the implementation class, this value may change over time to affect the rate of
	 * event production.
	 * 
	 * @return
	 * @throws SiteWhereException
